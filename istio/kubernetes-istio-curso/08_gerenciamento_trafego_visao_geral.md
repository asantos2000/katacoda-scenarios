...
`kubectl apply -f assets/exemplos/simul-shop/istio/8/front-end-canary-release.yaml`{{execute T1}}
...
`kubectl apply -f assets/exemplos/simul-shop/istio/8/front-end-config-error.yaml`{{execute T1}}
